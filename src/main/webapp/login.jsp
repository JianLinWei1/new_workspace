...
<link href="${ctx}/static/h-ui.admin/css/style.css"
	rel="stylesheet" type="text/css" />
<link href="${ctx}/lib/Hui-iconfont/1.0.8/iconfont.css"
	rel="stylesheet" type="text/css" />
...
<link rel="stylesheet"
	href="${ctx}/layer/theme/default/layer.css">
<!--[if IE 6]>
  ...
  <script>
	...
	<div class="loginWraper">
		<div id="loginform" class="loginBox">
			<form id="loginFrom" class="form form-horizontal"
        ...
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
            ...
            使我保持登录状态</label>
				...
				<div class="row cl">
					<div class="formControls col-xs-8 col-xs-offset-3">
						<input name="" id="loginSubmit" type="button" class="btn btn-success radius size-L"
